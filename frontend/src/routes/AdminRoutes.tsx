...
import QuanLySanPhamPage
  from "../features/admin/san-pham/pages/QuanLySanPhamPage";
import QuanLyDonHangPage
  from "../features/admin/don-hang/pages/QuanLyDonHangPage";
import QuanLyDanhMucSanPhamPage
  from "../features/admin/danh-muc-san-pham/pages/QuanLyDanhMucSanPhamPage";
import QuanLyNhaSanXuatPage
  from "../features/admin/nha-san-xuat/pages/QuanLyNhaSanXuatPage";
import QuanLyDonViTinhPage
  from "../features/admin/don-vi-tinh/pages/QuanLyDonViTinhPage";
import QuanLyHoatChatPage
  from "../features/admin/hoat-chat/pages/QuanLyHoatChatPage";
import QuanLyKhuyenMaiPage
  from "../features/admin/khuyen-mai/pages/QuanLyKhuyenMaiPage";
import QuanLyNhaCungCapPage
  from "../features/admin/nha-cung-cap/pages/QuanLyNhaCungCapPage";
import QuanLyPhieuNhapPage
