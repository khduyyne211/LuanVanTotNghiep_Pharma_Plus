...
export type DonHangDuocSiDanhSach = {
  maDonHang: number;
...
export type ChiTietDonHangDuocSi = {
...
export type DonHangDuocSiChiTiet = {
  maDonHang: number;
  maKhachHang: number | null;
  tenKhachHang: string | null;
  soDienThoaiKhachHang: string | null;
  ...
  coThuocKeDon: boolean;
  danhSachChiTiet: ChiTietDonHangDuocSi[];
};

export type DonHangDuocSiBoLoc = {
  page: number;
  size: number;
  keyword?: string;
  trangThaiDonHang?: TrangThaiDonHang;
...
export type CapNhatTrangThaiDonHangRequest = {
  trangThaiDonHang: TrangThaiDonHang;
};
