...
import com.pharma.backend.service.admin.DonViTinhService;
...
public class DonViTinhController {
    ...
    public DonViTinhResponse layChiTietDonViTinh(
    ...
    @PostMapping
    public DonViTinhResponse themDonViTinh(
    ...
    public DonViTinhResponse anDonViTinh(
            @PathVariable Long maDonViTinh
    ) {
    ...
    public DonViTinhResponse hienDonViTinh(
            @PathVariable Long maDonViTinh
    ) {
