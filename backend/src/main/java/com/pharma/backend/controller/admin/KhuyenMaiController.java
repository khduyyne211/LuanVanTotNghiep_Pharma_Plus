...
import com.pharma.backend.service.admin.KhuyenMaiSanPhamAdminQueryService;
...
public class KhuyenMaiController {
    ...
    private static final String VAI_TRO_ADMIN =
            "ADMIN";

    private final KhuyenMaiService service;

    private final KhuyenMaiSanPhamAdminQueryService
            sanPhamQueryService;

    @GetMapping
    public List<KhuyenMaiResponse>
    ...
    @GetMapping("/{maKhuyenMai}/san-pham")
    public List<KhuyenMaiSanPhamResponse>
    ...
    @GetMapping(
            "/{maKhuyenMai}/san-pham-co-the-gan"
    )
    ...
    @PutMapping("/{maKhuyenMai}/san-pham")
    public List<KhuyenMaiSanPhamResponse>
