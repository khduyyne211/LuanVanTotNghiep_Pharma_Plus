...
public class YeuCauTuVanDuocSiService {
    ...
    private final YeuCauTuVanRepository
            yeuCauTuVanRepository;

    private final NhanVienNoiBoRepository
            nhanVienNoiBoRepository;
    ...
    public PageResponseDto<YeuCauTuVanDuocSiDanhSachResponseDto>
        ...
        List<YeuCauTuVanDuocSiDanhSachResponseDto>
                danhSach =
                trangYeuCau
                        .getContent()
                        .stream()
                        .map(
                                this::toDanhSachResponse
                        )
                        .toList();
    ...
    public YeuCauTuVanDuocSiChiTietResponseDto
        ...
        TrangThaiTuVan trangThaiMoi =
                request.getTrangThaiTuVan();

        if (
                trangThaiMoi
                        != TrangThaiTuVan.DA_TU_VAN
                        &&
                trangThaiMoi
                        != TrangThaiTuVan.KHONG_THE_LIEN_HE
        ) {
            throw new ResponseStatusException(
                    HttpStatus.BAD_REQUEST,
    ...
    private YeuCauTuVanDuocSiDanhSachResponseDto
            toDanhSachResponse(
                    YeuCauTuVan yeuCau
            ) {
    ...
    private YeuCauTuVanDuocSiChiTietResponseDto
            toChiTietResponse(
                    YeuCauTuVan yeuCau
            ) {
